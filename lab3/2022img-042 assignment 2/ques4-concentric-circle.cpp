...
void display() {
    ...
    int centerX = 256;  // Center of the circles
    int centerY = 256;

    // Draw two concentric circles with different radii
    bresenhamCircle(centerX, centerY, 100);  // Outer circle
    bresenhamCircle(centerX, centerY, 50);   // Inner circle
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("Concentric Circles Using Bresenham's Algorithm");  // Create window
    init();
